package com.pistolshrimpstudio.mytestapp.controllers;
import org.springframework.web.bind.annotation.RestController;
import com.pistolshrimpstudio.mytestapp.models.Person;
...
public class PostRoutes {
    ...
    public String insertItem(@RequestBody Person person) {
        ...
        String insertedItem = String.format("Inserted item: %s", item);
        return insertedItem;
    }
}
